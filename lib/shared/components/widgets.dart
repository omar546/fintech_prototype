              ...
              child: Container(
                ...
                decoration: const BoxDecoration(
                    ...
                    border: DashedBorder.fromBorderSide(
                        dashLength: 8, side: BorderSide(color: Styles.blackColor, width: 2.5)),
                    borderRadius: BorderRadius.all(Radius.circular(10))),
                child: const Icon(Icons.add_circle_rounded),
              ),
            );
          } else {
            if(cards[index-1].operator == 'visa'){
            return
              CustomPaint(
...
paint_0_fill.color = Color(0xffFBE5A3).withOpacity(1.0);
...
paint_4_fill.color = Color(0xffA7A7A7).withOpacity(1.0);
...
paint_5_fill.color = Color(0xffA7A7A7).withOpacity(1.0);
